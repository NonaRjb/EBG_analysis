...
python3 train_logistic_reg.py --subject_id 0 --data ebg4 --data_type sensor_ica --modality ebg --tmin "$t" \
--tmax 0.5 --fmin 45 --fmax 70 -w 0.5 -c "$C" --seed 42 --save